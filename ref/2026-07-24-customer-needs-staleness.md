...
작성 2026-07-24 (유슨생 실기 중 두 번 걸림) · 상태: **✅ 해소됨 (2026-07-24, 같은 날)**

> **해법 = 대표 견적요청(featured request)** — 자동 갱신이 아니라 상담사가 요청 1건을 지정하고
> 니즈를 거기서 파생한다. 아래 논점 6개는 전부 그 설계에서 결론이 났다.
> - 설계(D1~D7) = `ref/specs/2026-07-24-crm-featured-quote-request-needs-design.md`
> - 구현 계획 = `ref/plans/2026-07-24-crm-featured-request-needs.md`
> - 구현 = `#349`(DB·파생 모듈·승격 시드·백필) + 대표 지정 API·star UI·read-only·프리셋 통일
>
> 아래는 **문제 관측 기록**으로 보존한다(왜 자동 갱신이 답이 아닌지의 근거).
