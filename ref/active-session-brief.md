...
**main 전량 green · 브랜치 0 · 미완 작업 없음.** 07-25 머지 **4건**(`#357`~`#360`) · prod `2ee2934` Active. 검증:
typecheck 0 · lint 0 · knip 0 · format 0 · unit **1152** · build · edge 26 · server **692** · 잔재 0.
...
1. **prod 눈 확인** — 픽커 로고·차량 이미지가 흰 배경에서 묻히는지(쉐보레 금색·흰색 차량) · 빈 니즈 카드.
2. **이전 세션 잔여** — V2 출고 prod 확인 3건(`#346`~`#348`) · Phase 2-6(AI 청크 재백필 — **의도적 보류**).
3. **`requireRole` 확산**(적용 2/11) — 단 `customers.ts`는 필드 단위 게이트가 정답이라 **이사님 항목 16 답을 받고** 착수.
