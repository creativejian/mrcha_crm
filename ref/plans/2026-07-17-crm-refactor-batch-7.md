...
2. **A#2 잔여**: "annualMileageKm 생략 = 무제한" 의미인지 제프 확인(스펙 §10류 파트너 문의 1줄). 확인 전 보수 대안 = 렌트 무제한 옵션 숨김.

## 기록만 / 후속 리스크 (이번 배치 조치 불필요)
- **C#1** 스냅샷 무효화 정책 — 복사 고유가 아니라 조건 편집 전반의 설계 질문(스냅샷=provenance 의미론). 제품 판단 섞임 — 후속 슬라이스 후보로만.
