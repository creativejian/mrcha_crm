...
const SIDEBAR_ONLY = new Set([
  ...
  "고객 상세",
  // ⚠️ 화면이 아직 없는 스텁이다 — 클릭해도 setSelectedDraftMenu로 사이드바 하이라이트만 바뀐다.
  // 초안에서 G O를 여기에 줬다가, 그 경로(/org-members)의 실제 이름이 계정 팝오버의
  // "조직 / 구성원"임을 실기에서 발견해 S O로 옮겼다(2026-08-08). 화면이 생기면 그때 키를 준다.
  "팀원 관리",
]);
