...
//
// 원칙: payload(build-payload.ts buildScenarioPayload)에 실리는 ScenarioState 키 ⊆ SCENARIO_QUERY_KEYS.
...
// buildScenarioPayload가 읽는 시나리오 필드가 늘면 여기에도 추가한다(query-fingerprint.test.ts가 잠금).
