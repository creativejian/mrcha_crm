...
async function sendRequest(url: string, method: "POST" | "PATCH" | "PUT" | "DELETE", body?: unknown): Promise<Response> {
...
export async function sendVoid(url: string, method: "POST" | "PATCH" | "PUT" | "DELETE", body?: unknown): Promise<void> {
