...
// 출고 정보 팝오버 본문은 components/DeliveryInfoPopover로 분리(2026-08-05) — 이 파일은 셀만 소유한다.
import { DeliveryInfoPopover } from "@/components/DeliveryInfoPopover";
...
import { deliveryInfoSummary, seedDeliveryInfoDraft, unconfirmedDeliveryDays, type DeliveryInfoDraft } from "@/lib/delivery-info";
