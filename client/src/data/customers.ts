...
export const initialCustomers: Customer[] = [
  ...
  { no: 11410, customerId: "CU-2605-0013", receivedAt: "2026-05-08 13:20", assignedAt: "5/08 13:45", team: "견적팀", name: "Daniel Kang", customerType: "개인사업자", customerTypeDetail: "현우스튜디오", phone: "010-9031-4208", vehicle: "Panamera", method: "운용리스", advisor: "이건수", statusGroup: "불발", status: "추후재컨택", date: "5/08 13:20", source: "디엘홈페이지", talkCount: "1/0", priority: "낮음", nextAction: "희망 월납 조건 기록 후 30일 뒤 재컨택 후보로 보류", aiSummary: "희망 조건과 가능 금융 조건 차이가 커서 이탈했으며 단기 계약 가능성은 낮음" },
