...
import { getTestDb } from "./hermetic-db";

// 아직 어떤 CRM 고객에도 연결되지 않은 profile id — customers.appUserId를 세팅하는 픽스처 전용.
...
// dual-mode: 실 master에선 실 profile을 읽고, hermetic PGlite에선 하네스 시드 profile이 뽑힌다.
